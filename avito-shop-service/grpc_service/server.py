...
from grpc_service.pvz_pb2_grpc import PVZServiceServicer, add_PVZServiceServicer_to_server
from grpc_service.pvz_pb2 import GetPVZListResponse, PVZ, DESCRIPTOR
